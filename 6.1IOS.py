...
while True:
    ...
    if nhanjob['status'] == 200:
        ...
        shortcut_url = f"shortcuts://run-shortcut?name=Mở%20Trình%20Duyệt&input={encoded_link}"
        print(f"Để mở liên kết '{link}', hãy sao chép và dán URL này vào trình duyệt iOS của bạn:")
        print(shortcut_url)
